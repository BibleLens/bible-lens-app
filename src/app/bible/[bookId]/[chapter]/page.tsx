    ...
    <div className="min-h-screen flex flex-col">
      ...
      >
        ...
        >
          ...
          {bookId === '1kings' && [5,6,7,8].includes(chapterNum) && <Link className="chapter-explorer-link" href={`/explore/temples/solomon?part=${chapterNum === 7 ? 'sea' : chapterNum === 8 ? 'ark' : 'sanctuary'}&cutaway=1&lens=sources`}>Explore Solomon’s Temple and the sources for its reconstruction →</Link>}
          {bookId === '2chronicles' && [3,4].includes(chapterNum) && <Link className="chapter-explorer-link" href={`/explore/temples/solomon?part=${chapterNum === 3 ? 'cherubim' : 'furnishings'}&cutaway=1&lens=sources`}>See the Temple’s objects in the 3D study →</Link>}
          {bookId === 'ezekiel' && chapterNum >= 40 && chapterNum <= 48 && <Link className="chapter-explorer-link" href={`/explore/temples/ezekiel?part=${chapterNum === 47 ? 'river' : chapterNum === 41 ? 'sanctuary' : chapterNum === 42 || chapterNum === 44 ? 'chambers' : chapterNum === 43 ? 'court' : 'gates'}&cutaway=1&lens=sources`}>Explore Ezekiel’s measured Temple vision →</Link>}
          {((bookId === 'luke' && chapterNum === 1) || (bookId === 'mark' && [12,13,15].includes(chapterNum)) || (bookId === 'john' && [2,10].includes(chapterNum)) || (bookId === 'acts' && chapterNum === 21)) && <Link className="chapter-explorer-link" href={`/explore/temples/herod?part=${bookId === 'luke' ? 'furnishings' : bookId === 'acts' ? 'soreg' : bookId === 'mark' && chapterNum === 12 ? 'women' : bookId === 'mark' && chapterNum === 15 ? 'veil' : 'sanctuary'}&cutaway=1&lens=connections`}>Explore the spaces of the late Second Temple →</Link>}
