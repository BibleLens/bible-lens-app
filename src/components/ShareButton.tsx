...
export function ShareButton() {
  ...
  return (
    <button
      ...
      className="p-2.5 rounded-none bg-[var(--color-bg-elevated)] border border-[var(--color-border)] text-[var(--color-text-secondary)] hover:text-[var(--color-text-primary)] hover:border-[var(--color-border-hover)] transition-colors min-h-[44px] min-w-[44px] flex items-center justify-center gap-1.5 text-base"
    >
      {copied ? (
        <>
          <svg
