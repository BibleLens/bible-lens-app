...
function BookCard({ book, canonicalIndex, style, onMouseMove, onMouseLeave }: BookCardProps) {
  ...
  return (
    ...
    >
      ...
      <div
        className="absolute inset-0 flex flex-col justify-start p-4 pt-6 pb-6 overflow-y-auto animate-content z-20 opacity-0 transition-opacity duration-500 group-hover:opacity-100"
        style={{
